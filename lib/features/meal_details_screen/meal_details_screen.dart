    ...
    return SafeArea(
      child: Scaffold(
        body: SingleChildScrollView(
          child: Column( // هنا نستخدم Column لعرض المحتوى بعد الصورة
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              SizedBox(width: 4.w),
                              Text(
                                '${meal.time} min', // إضافة وحدة الزمن
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 4.w),
                              Text(
                                meal.rate.toStringAsFixed(1), // توحيد شكل الرقم
                                style: TextStyles.black16Madium,
                              ),
                            ],
                          ),
